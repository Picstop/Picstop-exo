...
router.delete('/:id', CommentMiddleware.verifyAuthor, async (req, res, next) => Comments.deleteComment(req, res, next));

router.post('/:id/like', async (req, res, next) => Comments.likeComment(req, res, next));

router.patch('/:id', CommentMiddleware.verifyAuthor, async (req, res, next) => Comments.editComment(req, res, next));
